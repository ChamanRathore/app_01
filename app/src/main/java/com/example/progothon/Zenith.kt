...
class Zenith : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.rvzenith)  // Make sure to use the correct RecyclerView ID from your layout
        ...
        firestore.collection("clubs")
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    val event = Event(imageResId, title,"Zenith")
