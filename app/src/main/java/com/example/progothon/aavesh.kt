...
class aavesh : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aavesh)

        firestore = FirebaseFirestore.getInstance()
        recyclerView = findViewById(R.id.rvaavesh)  // Make sure to use the correct RecyclerView ID from your layout
        ...
        firestore.collection("clubs")
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    val event = Event(imageResId, title,"Aavesh")
