...
class Eunoia : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eunoia)

        firestore = FirebaseFirestore.getInstance()
        recyclerView = findViewById(R.id.rveunoia)  // Make sure to use the correct RecyclerView ID from your layout
        recyclerView.layoutManager = LinearLayoutManager(this)

        val selectedClub= intent.getStringExtra("key")
//        val intent = Intent(this, Fetch_deatils::class.java)
//        intent.putExtra("clubName", selectedClub)
        ...
        firestore.collection("clubs")
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    val event = Event(imageResId, title,"Eunoia")
